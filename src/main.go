...
import (
  ...
  "github.infra.hana.ondemand.com/cloudfoundry/chisel/client"
  "github.infra.hana.ondemand.com/cloudfoundry/chisel/server"
)
...
var help = `
  ...
  Read more:
    https://github.infra.hana.ondemand.com/cloudfoundry/chisel
